...
var PositionModel, PositionObserver, PositionProcessor, PositionStruct, now, onMovement, swinger;
...
PositionProcessor = (function() {
  ...
  PositionProcessor.prototype.extremes = function(history, attribute) {
    ...
    for (_i = 0, _len = history.length; _i < _len; _i++) {
      ...
      for (_j = 0, _len1 = history.length; _j < _len1; _j++) {
        j = history[_j];
        dist = this.distance(i[attribute], j[attribute], range[attribute]);
        if (dist > maxDistance) {
          maxDistance = dist;
          first = i;
          second = j;
  ...
  PositionProcessor.prototype.hasMoved = function(lambda) {
    ...
    return alpha.distance > (7.0 / 8.0) * (range["alpha"] / 2.0) || beta.distance > (7.0 / 8.0) * (range["beta"] / 2.0) || gamma.distance > (7.0 / 8.0) * (range["gamma"] / 2.0);
  };
